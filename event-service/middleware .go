...
//
// Um POST com Content-Type: application/json não é uma requisição simples,
// então o navegador manda um OPTIONS de preflight antes. Como o mux usa os
// padrões com método do Go 1.22 ("POST /events"), um OPTIONS que chegasse
// até ele cairia em 405, o preflight falharia e a requisição real nunca
// sairia. O middleware intercepta antes do roteamento.
